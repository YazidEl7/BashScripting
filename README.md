SFTP (Secure FTP): #Guided Quick SFTP Server Config# (run it as SU) Lately I was working on some powershell projects and I needed an SFTP to use and I hadn't much time.
